...
namespace DiarioProducao.Activities
{
  [
    Activity
    (
...
//aqui      SetContentView( Resource.Layout.Item );
      PegaParametros();
      InitClasses();
      DefineTela();
      PreencheCampos();
    ...
    {
//aqui      _codigoItem = FindViewById<EditText>( Resource.Id.txtCodigoItem );                                           // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _descricaoItem = FindViewById<EditText>( Resource.Id.txtDescricaoItem );                                     // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _matriculaFuncionario = FindViewById<EditText>( Resource.Id.txtMatriculaFuncionario );                       // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _nomeFuncionario = FindViewById<EditText>( Resource.Id.txtNomeFuncionario );                                 // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _horaInicio = FindViewById<EditText>( Resource.Id.txtHoraInicio );                                           // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _quantidadeFuncionariosInicio = FindViewById<EditText>( Resource.Id.txtQuantidadeFuncionariosInicio );       // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _horaFim = FindViewById<EditText>( Resource.Id.txtHoraFim );                                                 // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _quantidadeFuncionariosTermino = FindViewById<EditText>( Resource.Id.txtQuantidadeFuncionariosFim );     // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _quantidadeInformada = FindViewById<EditText>( Resource.Id.txtQuantidadeInformada );                         // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _quantidadeApontada = FindViewById<EditText>( Resource.Id.txtQuantidadeApontada );                           // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _dataApontamento = FindViewById<EditText>( Resource.Id.txtDataApontamento );                                 // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _txtProducaoItemObservacoesQuantidade = FindViewById<TextView>( Resource.Id.txtProducaoItemObservacoesQuantidade );               // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _txtProducaoItemOcorrenciasQuantidade = FindViewById<TextView>( Resource.Id.txtProducaoItemOcorrenciasQuantidade );               // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _txtProducaoItemFuncionariosQuantidade = FindViewById<TextView>( Resource.Id.txtProducaoItemFuncionariosQuantidade );               // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _producaoItemObservacoes = FindViewById<ListView>( Resource.Id.listaObservacoes );                                  // Associa um objeto a um elemento do XML
    }

    private void DefineListaOcorrencias()
    {
//aqui      _producaoItemOcorrencias = FindViewById<ListView>( Resource.Id.listaOcorrencias );                                  // Associa um objeto a um elemento do XML
    }

    private void DefineListaFuncionarios()
    {
//aqui      _producaoItemFuncionarios = FindViewById<ListView>( Resource.Id.listaFuncionarios );                                // Associa um objeto a um elemento do XML
    }
