...
namespace DiarioProducao.Activities
{
  ...
  public class ActDiario : Activity
  {
    ...
    protected override void OnCreate(Bundle savedInstanceState)
    {
      ...
      _codEmpresa = "10";
//aqui      SetContentView( Resource.Layout.Diario );
      AtualizaVersao();
      InitClasses();
      Campos();
    }
...
//aqui      _txtDenTurno = FindViewById<EditText>( Resource.Id.txtDenTurno ); // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _txtProducoesQuantidade = FindViewById<TextView>( Resource.Id.txtProducoesQuantidade ); // Associa um objeto a um elemento do XML
    ...
    {
//aqui      _btnPesquisar = FindViewById<Button>( Resource.Id.btnPesquisar ); // Associa um objeto a um elemento do XML
      _btnPesquisar.Click += ThreadingProcessar;
    }

    private void DefineBotaoLimpar()
    {
//aqui      _btnLimpar = FindViewById<Button>( Resource.Id.btnLimpar ); // Associa um objeto a um elemento do XML
      _btnLimpar.Click += LimpaCampos;
    }

    private void DefineListaProducoes()
    {
//aqui      _listViewProducoes = FindViewById<ListView>( Resource.Id.listProducoes ); // Associa um objeto a um elemento do XML
