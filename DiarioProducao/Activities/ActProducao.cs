...
//aqui            SetContentView(Resource.Layout.Producao);
        ...
        {
//aqui            _datProducao = FindViewById<EditText>(Resource.Id.txtData);     // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _txtDenLinha = FindViewById<EditText>(Resource.Id.txtDenLinha); // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _txtDenTurno = FindViewById<EditText>(Resource.Id.txtDenTurno); // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _txtProducaoItensQuantidade = FindViewById<TextView>(Resource.Id.txtProducaoItensQuantidade);               // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _listViewProducaoItem = FindViewById<ListView>(Resource.Id.listItens); // Associa um objeto a um elemento do XML
            _listViewProducaoItem.ItemClick += ListaProducaoItemClick;
        }

        private void DefineCampoProducaoObservacoesQuantidade()
        {
//aqui            _txtProducaoObservacoesQuantidade = FindViewById<TextView>(Resource.Id.txtProducaoObservacoesQuantidade);               // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _listViewProducaoObservacao = FindViewById<ListView>(Resource.Id.listObservacoes);
        }

        private void DefineCampoProducaoOcorrenciasQuantidade()
        {
//aqui            _txtProducaoOcorrenciasQuantidade = FindViewById<TextView>(Resource.Id.txtProducaoOcorrenciasQuantidade);               // Associa um objeto a um elemento do XML
        ...
        {
//aqui            _listViewProducaoOcorrencia = FindViewById<ListView>(Resource.Id.listOcorrencias);
        }
